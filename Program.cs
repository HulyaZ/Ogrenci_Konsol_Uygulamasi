...
namespace OgrenciYonetimSistemi
{
    class Program
    {
        ...
        static List<Ogrenci> Ogrenciler2;
        static Ogrenci ogr;
        static Adres Adresi;
        ...
        public static void SubeyeGoreListele6()
        {
            ...
            if (sube == "A")
            {
                ...
                foreach (Ogrenci ogre in Ogrenciler.Where(ogre => ogre.Subesi == SUBE.A).ToList())
                {
                    OgrenciSiralama(ogre);
                }
            }
            ...
            if (sube == "B")
            {
                ...
                foreach (Ogrenci ogre in Ogrenciler.Where(ogre => ogre.Subesi == SUBE.B).ToList())
                {
                    OgrenciSiralama(ogre);
                }
            }
            ...
            if (sube == "C")
            {
                ...
                foreach (Ogrenci ogre in Ogrenciler.Where(ogre => ogre.Subesi == SUBE.C).ToList())
                {
                    OgrenciSiralama(ogre);
                }
            }
        ...
        static public void SınıfınNotOrtalama8()
        {
            ...
            while (cikis == false)
            {
                ...
                if (sube == "A")
                {
                    List<Ogrenci> ASubesiOgrenciler = Ogrenciler.Where(ogre => ogre.Subesi == SUBE.A).ToList();//Beyza:list ile tanımlamazsak diğer subeler kaybolur
                ...
                if (sube == "B")
                {
                    List<Ogrenci> BSubesiOgrenciler = Ogrenciler.Where(ogre => ogre.Subesi == SUBE.B).ToList();//Beyza:list ile tanımlamazsak diğer subeler kaybolur
                ...
                if (sube == "C")
                {
                    List<Ogrenci> CSubesiOgrenciler = Ogrenciler.Where(ogre => ogre.Subesi == SUBE.C).ToList();//Beyza:list ile tanımlamazsak diğer subeler kaybolur
            ...
            {
                {
                    ...
                    if (sube == "A")
                    {
                        ...
                        foreach (Ogrenci ogre in Ogrenciler.Where(ogre => ogre.Subesi == SUBE.A).OrderByDescending(o => o.Ortalama).Take(5).ToList())
                        {
                            OgrenciSiralama(ogre);
                        }
                    }
                    ...
                    else if (sube == "B")
                    {
                        ...
                        foreach (Ogrenci ogre in Ogrenciler.Where(ogre => ogre.Subesi == SUBE.B).OrderByDescending(o => o.Ortalama).Take(5).ToList())
                        {
                            OgrenciSiralama(ogre);
                        }
                    }
                    ...
                    else if (sube == "C")
                    {
                        ...
                        foreach (Ogrenci ogre in Ogrenciler.Where(ogre => ogre.Subesi == SUBE.C).OrderByDescending(o => o.Ortalama).Take(5).ToList())
                        {
                            OgrenciSiralama(ogre);
                        }
                    }
            ...
            {
                {
                    ...
                    if (sube == "A")
                    {
                        ...
                        foreach (Ogrenci ogre in Ogrenciler.Where(ogre => ogre.Subesi == SUBE.A).OrderBy(o => o.Ortalama).Take(3).ToList())
                        {
                            OgrenciSiralama(ogre);
                        }
                    }
                    ...
                    else if (sube == "B")
                    {
                        ...
                        foreach (Ogrenci ogre in Ogrenciler.Where(ogre => ogre.Subesi == SUBE.B).OrderBy(o => o.Ortalama).Take(3).ToList())
                        {
                            OgrenciSiralama(ogre);
                        }
                    }
                    ...
                    else if (sube == "C")
                    {
                        ...
                        foreach (Ogrenci ogre in Ogrenciler.Where(ogre => ogre.Subesi == SUBE.C).OrderBy(o => o.Ortalama).Take(3).ToList())
                        {
                            OgrenciSiralama(ogre);
                        }
                    }
        ...
        public static void OgrenciEkle(int siraNumarasi)
        {
            ...
            while (kontrol)
            {
                ...
                if (cinsiyet == "E")
                {
                    ogr.Cins = CINSIYET.Erkek;
                    kontrol = false;
                }
                else if (cinsiyet == "K")
                {
                    ogr.Cins = CINSIYET.Kiz;
                    kontrol = false;
                }
                else
                {
        ...
        public static void SahteVeriGir()
        {
            ...
            Ogrenci ogr1 = new Ogrenci(15, "Erdem", "Durgun", new DateTime(2000, 5, 6), SUBE.C, CINSIYET.Erkek);
            Ogrenci ogr2 = new Ogrenci(25, "Ali", "Bardakçı", new DateTime(2000, 3, 2), SUBE.B, CINSIYET.Erkek);
            Ogrenci ogr3 = new Ogrenci(35, "Ayşe", "Eroğlu", new DateTime(2000, 6, 1), SUBE.A, CINSIYET.Kiz);
            Ogrenci ogr4 = new Ogrenci(45, "Buse", "Görgün", new DateTime(2000, 6, 7), SUBE.C, CINSIYET.Kiz);
            Ogrenci ogr5 = new Ogrenci(55, "Talat", "Sahici", new DateTime(2000, 7, 3), SUBE.A, CINSIYET.Erkek);
            Ogrenci ogr6 = new Ogrenci(65, "Yaren", "Acı", new DateTime(2000, 6, 1), SUBE.A, CINSIYET.Kiz);
            Ogrenci ogr7 = new Ogrenci(75, "Can", "Atılgan", new DateTime(2000, 3, 5), SUBE.B, CINSIYET.Erkek);
            Ogrenci ogr8 = new Ogrenci(85, "Isıl", "Ozturk", new DateTime(2000, 4, 8), SUBE.A, CINSIYET.Kiz);
            Ogrenciler.Add(ogr1);
            Ogrenciler.Add(ogr2);
            Ogrenciler.Add(ogr3);
            Ogrenciler.Add(ogr4);
        ...
        public static void CinsiyetGuncelle(Ogrenci ogre)
        {
            ...
            while (kontrol)
            {
                ...
                if (cinsiyet == "E")
                {
                    ogre.Cins = CINSIYET.Erkek;
                    kontrol = false;
                }
                else if (cinsiyet == "K")
                {
                    ogre.Cins = CINSIYET.Kiz;
                    kontrol = false;
                }
                else
                {
